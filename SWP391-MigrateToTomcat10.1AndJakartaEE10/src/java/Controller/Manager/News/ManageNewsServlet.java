...
public class ManageNewsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<News> result = dao.getAllNews();
        if (result == null || result.isEmpty()) {
            request.setAttribute("err", "Không có tin tức!");
            request.getRequestDispatcher("manager/news/listNews.jsp").forward(request, response);
        } else {
