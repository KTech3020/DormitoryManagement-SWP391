 ...
 */
package Controller.Manager.News;
...
public class EditNewsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("news", dao.getSingleNews(request.getParameter("notiID")));
        request.getRequestDispatcher("manager/news/editNews.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (part == null || part.getSize()==0) {
            ...
            response.sendRedirect("manager/news/listNews.jsp");
        } else {
