 ...
 * @author MSI GL63
 */
public class LoadPaymentRegistered extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet LoadPaymentRegistered</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet LoadPaymentRegistered at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        if(result.isEmpty() || result == null){
            ...
            request.getRequestDispatcher("user/room/paymentForRoom.jsp").forward(request, response);
        }
        else{
