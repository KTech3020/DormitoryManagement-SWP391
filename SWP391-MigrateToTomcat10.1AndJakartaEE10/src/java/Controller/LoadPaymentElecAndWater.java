...
public class LoadPaymentElecAndWater extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<ElectricWaterUsed> result = dao.viewElectricWater(semester, roomRegistration.getRegisterID());

        if (result == null) {
            request.setAttribute("err", "Không có tiền điện,nước cần thanh toán!");
