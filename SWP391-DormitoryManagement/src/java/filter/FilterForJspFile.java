...
public class FilterForJspFile implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if ((session.getAttribute("accountS") != null && URL.endsWith("listStudent.jsp"))) {
        ...
        else if ((session.getAttribute("accountS") == null && URL.endsWith("listNews.jsp")) || (session.getAttribute("accountS") == null && URL.endsWith("listStudent.jsp"))
